 ...
 * @since: 19-01-2015 11:15
 * @copyright: All right reserved.
 * created by IntelliJ IDEA
 */

class OM_BxSlider_Block_Adminhtml_Bxslider_Edit_Tab_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree  {
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('bxslider/edit/tab/category.phtml');
        $this->_withProductCount = false;
    }

    public function getBxSlider(){
        return Mage::registry('bxslider_data'); //use other registration key if you have one
    }

    public function isReadonly()
    {
        return $this->getBxSlider()->getCategoriesReadonly();
    }

    public function getCategoryIds(){
        if (is_null($this->_categoryIds)){
            $categories = $this->getBxSlider()->getCategoryId();
